...
export function createBattleshipServer(): McpServer {
  ...
  server.registerTool(
    "create_game",
    {
      description: "Create a new battleship game. Returns a game code to share with opponent and a player token for authentication.",
      inputSchema: {
  ...
  server.registerTool(
    "join_game",
    {
      description: "Join an existing battleship game using a game code.",
      inputSchema: {
  ...
  server.registerTool(
    "get_game_state",
    {
      description: "Get the current state of your battleship game including your board, shots fired, and whether it's your turn.",
      inputSchema: {
  ...
  server.registerTool(
    "place_ships",
    {
      description: `Place your ships on the board. Ships required: Carrier (5), Battleship (4), Cruiser (3), Submarine (3), Destroyer (2). Each ship needs positions as {x, y} coordinates (0-9). Ships must be in a straight line (horizontal or vertical) and cannot overlap.`,
      inputSchema: {
  ...
  server.registerTool(
    "fire",
    {
      description: "Fire at a position on your opponent's board. Coordinates are 0-9 for both x and y.",
      inputSchema: {
        playerToken: z.string().describe("Your player token"),
  ...
  server.registerTool(
    ...
    {
      description: "Get code examples for subscribing to real-time game updates using Supabase Realtime. Useful for building clients that need live updates without polling.",
      inputSchema: {
